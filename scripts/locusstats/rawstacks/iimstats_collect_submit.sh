...
FA_OG=$(ls -1 $DIR_LOCUSFASTA_OG/Locus*1*1* | head -n 1)
FA_W1=$(ls -1 $DIR_LOCUSFASTA_W1/Locus*1*1* | head -n 1)
FA_W2=$(ls -1 $DIR_LOCUSFASTA_W2/Locus*1*1* | head -n 1)
FA_BW=$(ls -1 $DIR_LOCUSFASTA_BW/Locus*1*1* | head -n 1)
